    ...
    <div class="row">
        <div class="col-md-8 col-md-offset-2">
            <div class="panel panel-default">
                <div class="panel-heading">Sipariş Durumunu Düzenle</div>
                    ...
                    <form class="form-horizontal" id="update-order-status-form" method="post" action="{{ route('admin.orders.update', $order) }}">
                        ...
                        <fieldset>
                            ...
                            <div class="form-group m-b-lg">
                                <label class="control-label col-lg-3">Sipariş NO</label>
                                <div class="col-lg-8">
                            ...
                            <div class="form-group m-b-lg">
                                <label class="control-label col-lg-3">Müşteri</label>
                                <div class="col-lg-8">
                            ...
                            <div class="form-group m-b-lg">
                                <label class="control-label col-lg-3">Boyut</label>
                                <div class="col-lg-8">
                            ...
                            <div class="form-group m-b-lg">
                                <label class="control-label col-lg-3">Malzemeler</label>
                                <div class="col-lg-8">
                            ...
                            <div class="form-group">
                                <label for="status_id" class="control-label col-lg-3">Durum</label>
                            ...
                            <div class="form-group">
                                ...
                                <div class="controls col-lg-8">
                                    <div class="form-actions">
                                        <button type="submit" id="update-order" class="btn btn-success">Durumu Güncelle</button>
                                    </div> <!-- /form-actions -->
                                </div>
                            </div>
